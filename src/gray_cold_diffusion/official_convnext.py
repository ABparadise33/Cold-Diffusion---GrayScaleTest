# Vendored verbatim from arpitbansal297/Cold-Diffusion-Models
# commit f8b1379151ff0cccba49112cf61d439bd4dd4ad9
# decolor-diffusion/diffusion/model/unet_convnext.py
# Upstream authors: Cold Diffusion authors; architecture based on lucidrains.
# No license grant is asserted here; see docs/official_colorization.md for provenance.
# ruff: noqa
import math
import torch
